...
//
// Thermometer (Fahrenheit) and Hygrometer Example
// 
...
//
// Hardware:
// 4 Nixie Tubes - counting from the right: IN-15B (F, H), IN-12B (digits and dot), 2 x IN-12A or 2 x IN-12B 
...
// Temperature and humidity symbols (nixie array cathode numbers)
#define nixieF    9         // F - temperature
#define nixieH    6         // H - humidity
...
void loop() 
{
    ...
    tempDHT = dht.readTemperature(true);
    ...
    tempDHT = dht.computeHeatIndex(tempDHT, humDHT);
...
void DisplayTemperature()
{
    ...
    digit1 = nixieF;                    // Set "F" symbol for temperature            
...
void DisplayHumidity()
{
    ...
    digit1 = nixieH;                   // Set "H" symbol for humidity
...
void SlotMachine()
{
    ...
    {   
        ...
        if(digit1 == 3 || digit1 == 8) digit1 = digit1 + 1;    // There are no cathodes 3 and 8        
